    ...
    <div id="main-sidebar">
        <ul class="nav">
            ...
            @if (auth()->guard('admin')->user()->role == 0)
                ...
                <li class="nav-item {{ sidenav_active('admin.deposit.list.auditor') }} {{ sidenav_active('admin.report.single.shares_trx.auditor') }}">
                ...
                <ul class="sub-menu">
                    <!--
                        <li class="nav-item {{ sidenav_active('admin.report.single.shares_trx.auditor') }}">
                             <a class="nav-link" href="{{ route('admin.report.single.auditor') }}">
                                  <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                  <span class="menu-title">Sell Contract TRX</span>
                             </a>
                    </li>
                    -->
                        
                         <li class="nav-item {{ sidenav_active('admin.auditor.paises') }}">
                            <a class="nav-link" href="{{ route('admin.auditor.paises') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Users by Pais</span>
                            </a>
                        </li>

                        <li class="nav-item {{ sidenav_active('admin.auditor.mvimiento') }}">
                            <a class="nav-link" href="{{ route('admin.auditor.movimiento') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Movimientos</span>
                            </a>
                        </li>
                        <li class="nav-item {{ sidenav_active('admin.report.consolidado') }}">
                            <a class="nav-link" href="{{ route('admin.report.consolidado',date('Y-m-d')) }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Consolidado</span>
                            </a>
                        </li>

                        <li class="nav-item {{sidenav_active('admin.deposit.list.auditor')}}">
                            <a class="nav-link" href="{{route('admin.deposit.list.auditor')}}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title"> Deposit via Admin</span>
                            </a>
                        </li>

                        <li class="nav-item {{sidenav_active('admin.rank.user')}}">
                            <a class="nav-link" href="{{route('admin.rank.user')}}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">User Rank</span>
                            </a>
                        </li>
                ...
                <li class="nav-item {{ sidenav_active('admin.products.*') }}">

                    <a data-default-url="#" class="nav-link">
                        <span class="menu-icon"><i class="fa fa-bank text-facebook"></i></span>
                        <span class="menu-title">Products</span>
                    
                            <span class="badge bg-warning border-radius-10">New</span>    
                        <span class="menu-arrow"><i class="fa fa-chevron-right"></i></span>
                    </a>

                    <ul class="sub-menu">
                            <li class="nav-item {{ sidenav_active('admin.products.action') }}">
                                <a href="{{ route('admin.products.acciones') }}" class="nav-link">
                                  <span class="menu-icon"><i class="fa fa-bullhorn text-facebook"></i></span>
                                    <span class="menu-title">Actions Setting</span>
                                </a>
                            </li>

                            <li class="nav-item {{ sidenav_active('admin.products.fundadores') }}">
                                <a href="{{ route('admin.products.fundadores') }}" class="nav-link">
                                   <span class="menu-icon"><i class="fa fa-bullhorn text-facebook"></i></span>
                                    <span class="menu-title">founders Setting</span>
                                </a>
                            </li>
            ...
            <li class="nav-item {{ sidenav_active('admin.product.index') }} {{ sidenav_active('admin.network.contract.index') }} 
                      {{ sidenav_active('admin.trx.index') }} {{ sidenav_active('admin.pool.interest') }} {{ sidenav_active('admin.pooltrx.interest') }} 
                      {{ sidenav_active('admin.matrix.plan') }} {{ sidenav_active('admin.compensation.plan') }}  ">
                <a data-default-url="{{ route('admin.ticket') }}" class="nav-link">
                    <span class="menu-icon"><i class="fa fa-ticket text-facebook"></i></span>
                    <span class="menu-title">Setting Contracts</span>
                    <span class="menu-arrow"><i class="fa fa-chevron-right"></i></span>
                </a>
                <ul class="sub-menu">
                            ...
                            <li class="nav-item {{ sidenav_active('admin.trx.index') }}">
                                <a href="{{ route('admin.trx.index') }}" class="nav-link">
                                    <span class="menu-icon"><i class="fa fa-bullhorn text-facebook"></i></span>
                                    <span class="menu-title">Contract TRX Settings</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item {{ sidenav_active('admin.pool.interest') }}">
                                <a href="{{ route('admin.pool.interest') }}" class="nav-link">
                                    ...
                                    <span class="menu-title">Pool Interest ETH</span>
                                </a>
                            </li>

                            <li class="nav-item {{ sidenav_active('admin.pooltrx.interest') }}">
                                <a href="{{ route('admin.pooltrx.interest') }}" class="nav-link">
                                    <span class="menu-icon"><i class="fa fa-product-hunt text-facebook"></i></span>
                                    <span class="menu-title">Pool Interest TRX</span>
                                </a>
                            </li>
                ...
                <li class="nav-item {{ sidenav_active('admin.lotto*') }}">
                <a data-default-url="{{ route('admin.ticket') }}" class="nav-link">
                    <span class="menu-icon"><i class="fa fa-ticket text-facebook"></i></span>
                    <span class="menu-title">Lotto Procash</span>
                    <span class="menu-arrow"><i class="fa fa-chevron-right"></i></span>
                </a>
                <ul class="sub-menu">
                                   <li class="nav-item {{ sidenav_active('admin.lottocar.request.index') }}">
                                    <a href="{{ route('admin.lottocar.request.index') }}" class="nav-link">
                                        <span class="menu-icon"><i class="fa fa-list text-facebook"></i></span>
                                        <span class="menu-title">Lotto Car</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ sidenav_active('admin.lotto.request.index') }}">
                                    <a href="{{ route('admin.lotto.request.index') }}" class="nav-link">
                                        <span class="menu-icon"><i class="fa fa-list text-facebook"></i></span>
                                        <span class="menu-title">Lotto</span>
                                    </a>
                                </li>
                                
                                <li class="nav-item {{ sidenav_active('admin.lotto.request.oficial') }}">
                                    <a href="{{ route('admin.lotto.request.oficial') }}" class="nav-link">
                                        <span class="menu-icon"><i class="fa fa-list text-facebook"></i></span>
                                        <span class="menu-title">Lotto Details</span>
                                    </a>
                                </li>
                            
                                <li class="nav-item {{ sidenav_active('admin.lotto.request.site') }}">
                                    <a href="{{ route('admin.lotto.request.site') }}" class="nav-link">
                                        <span class="menu-icon"><i class="fa fa-list text-facebook"></i></span>
                                        <span class="menu-title">Lotto Run</span>
                                    </a>
                                </li>
                    </ul>
                </li>
            ...
            <li class="nav-item {{ sidenav_active('admin.users*') }}">
                ...
                <ul class="sub-menu">
                    <li class="nav-item {{ sidenav_active('admin.users.all') }}">
                     ...
                     <li class="nav-item {{ sidenav_active('admin.users.ajuste') }}">
                        <a class="nav-link" href="{{ route('admin.users.ajuste') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title"> Users ajustes</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item {{ sidenav_active('admin.users.kyc') }}">
                        <a class="nav-link" href="{{ route('admin.users.kyc') }}">
                            <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                            <span class="menu-title">Kyc  Users</span>
                ...
                <li class="nav-item {{ sidenav_active('admin.withdraw*') }}">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item {{ sidenav_active('admin.withdraw.request*') }}">
                            <a class="nav-link" href="{{ route('admin.withdraw.request.create',1) }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Withdraw create Ethereum</span>
                            </a>
                        </li>
                        <li class="nav-item {{ sidenav_active('admin.withdraw_tron.request*') }}">
                            <a class="nav-link" href="{{ route('admin.withdraw_tron.request.create',1) }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Withdraw create Tron(Trx)</span>
                            </a>
                        </li>
                         <li class="nav-item {{ sidenav_active('admin.withdraw_usdt.request*') }}">
                            <a class="nav-link" href="{{ route('admin.withdraw_usdt.request.create',1) }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Withdraw create Theter(USDT)</span>
                            </a>
                        </li>

                        <li class="nav-item {{ sidenav_active('admin.withdraw_tron.request.lote') }}">
                            <a class="nav-link" href="{{ route('admin.withdraw_tron.request.lote') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Withdraw create Lote(Trx)</span>
                            </a>
                        </li>

                        <li class="nav-item {{ sidenav_active('admin.withdraw.send') }}">
                            <a class="nav-link" href="{{ route('admin.withdraw.send') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Withdraw Send</span>
                            </a>
                        </li>
                       <li class="nav-item {{ sidenav_active('admin.withdraw.approved') }}">
                        ...
                        <li class="nav-item {{ sidenav_active('admin.withdraw.log') }}">
                         ...
                         <li class="nav-item {{ sidenav_active('admin.withdraw.method.methods') }}">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item {{ sidenav_active('admin.report.transaction*') }}">
                            <a class="nav-link" href="{{ route('admin.report.transaction') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">All Transactions Log</span>
                            </a>
                        </li>

                        <li class="nav-item {{ sidenav_active('admin.report.point*') }}">
                            <a class="nav-link" href="{{ route('admin.report.point') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">All Points Log</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item {{ sidenav_active('admin.report.shares*') }}">
                            <a class="nav-link" href="{{ route('admin.report.shares') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Contracts Sell ETH/TRX Log</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item {{ sidenav_active('admin.report.pool.interest*') }}">
                            <a class="nav-link" href="{{ route('admin.report.pool.interest') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Pool Payments ETH/TRX</span>
                            </a>
                        </li>
                       ...
                       <!-- <li class="nav-item {{ sidenav_active('admin.report.pool.interest*') }}">
                            <a class="nav-link" href="{{ route('admin.report.pool.interest') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Pool Interest TRX Log</span>
                            </a>
                        </li>
                        -->
                        ...
                        <li class="nav-item {{ sidenav_active('admin.report.interest.log*') }}">
                            <a class="nav-link" href="{{ route('admin.report.interest.log') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Interest ETH/TRX Log</span>
                            </a>
                        </li>
               ...
               <!-- <li class="nav-item {{ sidenav_active('admin.plugin*') }}">
                ...
                <li class="nav-item {{ sidenav_active('admin.setting*') }}">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item {{ sidenav_active('admin.premiun-index') }}">
                            <a class="nav-link" href="{{ route('admin.premiun-index') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                        ...
                        <li class="nav-item {{ sidenav_active('admin.setting.smart') }}">
                            <a class="nav-link" href="{{ route('admin.setting.smart') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Smart Contract ETH</span>
                            </a>
                        </li>
                        
                        <li class="nav-item {{ sidenav_active('admin.setting.smart_tron') }}">
                            <a class="nav-link" href="{{ route('admin.setting.smart_tron') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
                                <span class="menu-title">Smart Contract TRX</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item {{ sidenav_active('admin.pop.index') }}">
                            <a class="nav-link" href="{{ route('admin.pop.index') }}">
                                <span class="mr-2"><i class="fa fa-angle-right"></i></span>
